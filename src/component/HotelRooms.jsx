...
} from "../shared/Pixel/metaPixelEvents";
...
export default function HotelRooms() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(
        error.message || "Field to create booking, Something went wrong."
      );
      setIsLoading(false);
  ...
  return (
    <>
      <Modal error={error} ref={modalRef} onClose={handleClose} />
      <div className="min-h-screen bg-gray-900 text-gray-100">
        ...
        <div className="flex justify-center flex-col space-x-4 mb-8">
          {hotel.images.map((img, index) => (
            <img
              key={index}
              src={`${process.env.REACT_APP_BACKEND_URL}/${img}`}
