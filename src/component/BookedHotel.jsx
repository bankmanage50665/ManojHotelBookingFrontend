...
import { FaCalendarAlt, FaRupeeSign, FaUser } from "react-icons/fa";
...
export default function BookedHotel() {
  ...
  const totalPrice = booking.bookedRooms.reduce((totalPrice, hotel) => {
    return totalPrice + hotel.totalPrice;
  }, 0);
                ...
                <div className="flex flex-col sm:flex-row justify-between items-center">
                  <div className="text-gray-300 mb-4 sm:mb-0">
                    ...
                    <p className="text-sm text-gray-400 mt-1">
                      ...
                      {booking.bookedRooms.length === 1 ? "room" : "rooms"}{" "}
                      booked
                    </p>
                  </div>
                  ...
                  <div className="md:flex">
                    ...
                    <div className="p-10 md:w-3/5">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                        ...
                        <div>
                          <HelplineNumber phoneNumber={booking.hotelId.phone}>
                            {" "}
                            Helpline Number{" "}
                          </HelplineNumber>
                        </div>
